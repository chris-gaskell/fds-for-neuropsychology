...
## An Introduction to Working with Functional Dissociative Seizures {style="font-size: 35px; text-align: center;"}
...
::: {style="text-align: center"}
[https://fds-for-neuropsychology.netlify.app](https://fds-for-neuropsychology.netlify.app){.uri style="text-align: center"}
:::
...
[^3]: See this video by [John Stone](https://www.youtube.com/watch?v=ersm5f_0LVI&t=21s%22) or the excellent [review paper](https://www.bmj.com/content/380/bmj.p221) on 'functional' vs 'organic'
...
## Who Is Involved in Diagnosis? {visibility="hidden"}
...
## Symptoms: Functional Movement {background-color="white"} {visibility="hidden"}
...
## To Clarify {background-color="white"} {visibility="hidden"}
...
## Professional Beliefs {background-color="white"} {visibility="hidden"}
...
## Trauma & FND Onset {background-color="white"} {visibility="hidden"}
...
## Biopsychosocial & 3 Ps {background-color="white"}
...
## Integrated Cognitive Model {background-color="white"} {visibility="hidden"}
...
## Emotional Processing Model {background-color="white"} {visibility="hidden"}
...
## Emotional Processing Model {visibility="hidden"} {visibility="hidden"}
...
## What to Measure? {background-color="white"} {visibility="hidden"}
...
## Ways to Intervene {visibility="hidden"}
...
## What else can help {visibility="hidden"}
...
## Tips for Acute Management {background-color="white"} {visibility="hidden"}
...
::: {style="text-align: center; padding: 200px 0;"}
# Resources {background-color="#01364C"}
:::
